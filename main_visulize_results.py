...
list_name_model = ["CR-QIFA", "DiffFIQA", "IMINT", "CR-ONTOP-14K_KL", "CR-ONTOP-266K", "CF-ONTOP-TRUTH-SUB-NNCCS"]
list_path_score = [
    ...
    # f"/data/disk2/tanminh/Evaluate_FIQA_EVR/data/processed_{name_dataset}/CR_ONTOP_10K_MULTI_FC_scores.txt",

    f"/data/disk2/tanminh/Evaluate_FIQA_EVR/data/processed_{name_dataset}/CR_ONTOP_10K_MULTI_FC_KL_scores.txt",
    f"/data/disk2/tanminh/Evaluate_FIQA_EVR/data/processed_{name_dataset}/CR_ONTOP_10K_MULTI_FC_KL_NORM_scores.txt",
    # f"/data/disk2/tanminh/Evaluate_FIQA_EVR/data/processed_{name_dataset}/CR_ONTOP_10K_MULTI_FC_KL_FIXBUG_scores.txt",
    f"/data/disk2/tanminh/Evaluate_FIQA_EVR/data/processed_{name_dataset}/ViT_FIQA_scores.txt",
