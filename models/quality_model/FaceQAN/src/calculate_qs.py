...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--image_paths", default="[22-Tony_Blair_0003.jpg]", type=str, nargs="+", help=" Location of images for which to generate scores ")
    ...
    parser.add_argument("-sp", "--save_path", required=False, type=str, default=".", help=" Path to location where the results will be stored. ")
    ...
    args.image_paths = ["22-Tony_Blair_0003.jpg"]
